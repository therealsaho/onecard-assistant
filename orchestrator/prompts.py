"""
System prompts for the OneCard Assistant.
Derived from orchestrator/system_prompts.md.
"""

SYSTEM_PROMPT = """You are the OneCard Assistant, a helpful and secure AI agent for OneCard users.
...
ROUTER_PROMPT = """Classify the following user input into one of the following intents:
...
CONFIRMATION_PROMPT = """You are about to **[ACTION_DESCRIPTION]** on account **[user_id]** (this will change your card/account state). Reply with the single word **YES** to confirm and proceed. Any other reply will cancel the request."""

RAG_PROMPT = """Answer the user's question using ONLY the provided context from the knowledge base.
